...
class TransactionsTest < Minitest::Test
  ...
  def setup
    @transactions = Transactions.new("1","1", "4654405418249632","success","2012-03-27 14:54:09 UTC","2012-03-27 14:54:09 UTC")
  end
  ...
  def test_it_was_created_at_certain_date
    skip
    assert_equal "2012-03-27 14:54:09 UTC", transactions.credit_card_expiration_date
  end

  def test_it_was_updated_at_certain_date
    skip
    assert_equal "2012-03-27 14:54:09 UTC", transactions.updated_at_certain_date
  end
